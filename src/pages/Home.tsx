    ...
    <div className="min-h-screen">
      ...
      <section className="py-20 px-4 bg-gray-50">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-3xl md:text-4xl font-bold text-center mb-12">Our Featured Programs</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white rounded-lg overflow-hidden shadow-lg transform hover:scale-105 transition-transform duration-300">
              ...
              />
              <div className="p-6">
                <h3 className="text-xl font-semibold mb-2">Education Initiative</h3>
            ...
            <div className="bg-white rounded-lg overflow-hidden shadow-lg transform hover:scale-105 transition-transform duration-300">
              ...
              <div className="p-6">
                ...
                <p className="text-gray-600">Ensuring accessible healthcare services for rural and urban communities.</p>
              </div>
            </div>
            ...
            <div className="bg-white rounded-lg overflow-hidden shadow-lg transform hover:scale-105 transition-transform duration-300">
              ...
              <div className="p-6">
                ...
                <p className="text-gray-600">Supporting sustainable livelihoods through skill development and microfinance.</p>
              </div>
            </div>
          </div>
        </div>
