      ...
      <div className="max-w-7xl mx-auto px-4">
        <div className="flex justify-between h-16">
          ...
          <div className="hidden md:flex items-center space-x-8">
            <Link
              to="/"
              className={`${isActive('/') ? 'text-orange-500' : 'text-gray-600'} hover:text-orange-500 px-3 py-2 text-sm font-medium transition-colors duration-200`}
            >
              Home
            </Link>
            <Link
              to="/about"
              className={`${isActive('/about') ? 'text-orange-500' : 'text-gray-600'} hover:text-orange-500 px-3 py-2 text-sm font-medium transition-colors duration-200`}
            >
              About Us
            </Link>
            <Link
              to="/work"
              className={`${isActive('/work') ? 'text-orange-500' : 'text-gray-600'} hover:text-orange-500 px-3 py-2 text-sm font-medium transition-colors duration-200`}
            >
              Our Work
            </Link>
            <Link
              to="/get-involved"
              className={`${isActive('/get-involved') ? 'text-orange-500' : 'text-gray-600'} hover:text-orange-500 px-3 py-2 text-sm font-medium transition-colors duration-200`}
            >
              Get Involved
            </Link>
            <Link
              to="/contact"
              className={`${isActive('/contact') ? 'text-orange-500' : 'text-gray-600'} hover:text-orange-500 px-3 py-2 text-sm font-medium transition-colors duration-200`}
            >
              Contact
            </Link>
            <Link
